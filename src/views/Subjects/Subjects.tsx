                                                ...
                                                >
                                                    <div className="flex justify-between items-start">
                                                        ...
                                                        <span className={`px-2 py-1 rounded-full text-xs self-start ${
                                                            course.cupo_disponible > 10 ? 'bg-green-100 text-green-800' : 
                                                    ...
                                                    <div className="mt-2 text-sm text-gray-500">
                                                        ...
                                                        <p>{course.horario}</p>                                                        <p className="mt-1">Semestre: {
                                                            (() => {
                                                                if (!course.semestre) return "No disponible";
                                                                
                                                                const parts = course.semestre.split('-');
                                                                if (parts.length !== 2) return course.semestre;
                                                                
                                                                const [ano, periodo] = parts;
                                                                let periodoTexto = '';
                                                                switch(periodo) {
                                                                    case '1': periodoTexto = 'Primavera'; break;
                                                                    case '2': periodoTexto = 'Verano'; break;
                                                                    case '3': periodoTexto = 'Otoño'; break;
                                                                    default: periodoTexto = periodo;
                                                                }
                                                                return `${periodoTexto} ${ano}`;
                                                            })()
                                                        }</p>
                                                    ...
                                                    <div className="mt-3 flex justify-between items-center">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`px-3 py-1.5 rounded-md transition flex items-center text-sm ${
